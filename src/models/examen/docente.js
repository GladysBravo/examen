/**
* Módulo que mapea las docenteS existentes, cada docente sólo debería estar
...
module.exports = (sequelize, DataType) => {
  const docente = sequelize.define('docente', {
    ...
    documento_identidad: {
      ...
      validate: {
        len: { args: [5, 25], msg: 'El campo \'Documento de identidad\' permite un mínimo de 5 caracter y un máximo de 10 caracteres' },
    ...
    nombres: {
      ...
      allowNull: false,
      validate: {
        len: { args: [1, 50], msg: 'El campo \'Nombres\' permite un mínimo de 1 caracter y un máximo de 50 caracteres' },
    ...
    primer_apellido: {
      ...
      allowNull: true,
      validate: {
        len: { args: [0, 50], msg: 'El campo \'Primer apellido\' permite un mínimo de 1 caracter y un máximo de 50 caracteres' },
    ...
    segundo_apellido: {
      ...
      allowNull: true,
      validate: {
        len: { args: [0, 50], msg: 'El campo \'Segundo apellido\' permite un máximo de 50 caracteres' },
